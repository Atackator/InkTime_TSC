...
Cant.,Referințe,Valoare,Capsulă (Package),Descriere,MPN
...
3,"C1-EP-DR, C24, C39",10uF,0402,Generic chip capacitor,
3,"C10, C13, C22",N.C.,0201,Generic chip capacitor,
1,C11,100pF,0201,Generic chip capacitor,
1,C15,1.0uF,0201,Generic chip capacitor,
1,C16,47nF,0201,Generic chip capacitor,
1,C2-EP-DR,4.7uF/25V,0402,Generic chip capacitor,
4,"C23, C27, C34, C42",0.1uF,0201,Check availability,
2,"C25, C33",22uF,0402,Generic chip capacitor,
6,"C29, C30, C31, C32, C37, C38",1uF,0201,Generic chip capacitor,
2,"C3, C4",1pF,0201,Generic chip capacitor,
1,C43,4.7uF,0201,Generic chip capacitor,
5,"C5, C7, C8, C12, C19",100nF,0201,Generic chip capacitor,
4,"C6, C14, C20, C21",4.7uF,0201,Generic chip capacitor,
1,C9,820pF,0201,Generic chip capacitor,
3,"D2, D4, D5",MBR0530,SOD123,Schottky Diode 0.5A 30V,
1,D3,USBLC6-2SC6Y,SOT-23-6,ESD Protection,
9,EPD_C1 ... EPD_C12,1uF/50V,0402,Generic chip capacitor,
...
1,L7,FTC252012SR47MBCA,0806,SMD Inductor 0.47uH,C5832368
1,Q1,20V/4.2A,SOT23-3,P-channel MOSFET,
6,"R2, R3, R4, R5, R7, R8",0 / 10k,0201,Thick Film Resistor,
